...
#implementation from https://github.com/Eric-mingjie/rethinking-network-pruning/blob/master/cifar/network-slimming/models/preresnet.py
__all__ = ['resnet']
...
class resnet(nn.Module):
    def __init__(self, depth=14, cfg=None):
